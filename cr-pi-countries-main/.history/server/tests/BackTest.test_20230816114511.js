...
describe('Prueba de rutas', () => {
    ...
    test('Ruta "Crear Actividad"', async() => {
        ...
        // expect(response.body).toHaveLength(1);
        expect(response.statusCode).toBe(200);
        expect(response.body.Countries).toEqual(expect.arrayContaining([{"Countries": [], "countryId": ["SMR"], "description": null, "difficulty": 3, "duration": 2, "id": 3, "imageURL": null, "name": "Actividad 1", "season": "Otoño"},]));
    })
