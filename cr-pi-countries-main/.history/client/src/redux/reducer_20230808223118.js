...
export const reducer = (state=initialState,action) =>{  
    switch(action.type){
        ...
        case NAME_SEARCH:
            ...
            if(typeof action.payload === "error"){console.log(action.payload);return{...state,countriesFiltered:[], errorMessage: action.payload.message}}
            else if(typeof action.payload !== "string" || !regexpSearch.test(actionPayload)){return{...state,countriesFiltered:[], errorMessage: "Search term must be plain text"}}
