import { ADD_COUNTRIES, ID_SEARCH, NAME_SEARCH, FILTER, ACTIVITY_CREATE, ORDER, ADD_ACTIVITIES, REMOVE_ACTIVITY, UPDATE_ACTIVITY } from "./actions.js"
...
export const reducer = (state=initialState,action) =>{  
    switch(action.type){
        ...
        case NAME_SEARCH:
            if(!Array.isArray(action.payload)){return{...state,countriesFiltered:[], errorMessage: action.payload.response.data}}
            else {
                return{
                    ...state,
