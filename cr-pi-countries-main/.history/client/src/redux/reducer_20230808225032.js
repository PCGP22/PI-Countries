...
export const reducer = (state=initialState,action) =>{  
    switch(action.type){
        ...
        case NAME_SEARCH:
            ...
            let regexpSearch = /^[A-Z]+$/i
            console.log(regexpSearch.test(action.payload))
            if(typeof action.payload === "object"){return{...state,countriesFiltered:[], errorMessage: action.payload.response.config.data}}
            else if(!Array.isArray(action.payload) && !regexpSearch.test(action.payload)){return{...state,countriesFiltered:[], errorMessage: "Search term must be plain text"}}
