                ...
                {activities && activities.map(a=>{
                    ...
                    return(
                        <div className='activityBox' key={a.id}>
                            <Link to={`/countries/activities/${a.id}`}>Edit</Link>
                            <button type='button' onClick={handleDeleteActivity} className='activityContainer__closeButton' value={a.id}>X</button>
