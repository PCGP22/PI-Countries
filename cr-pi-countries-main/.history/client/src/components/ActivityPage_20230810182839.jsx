...
const validar = (inputs) =>{
    ...
    if(inputs.imageURL === "Please enter a valid image URL"){
...
function ActivityPage(props) {
    ...
    const handleChange = (e) => {
        if(e.target.name === "description"){
            console.log(inputs.description.length > 200)
        }
    ...
    const handleImgError = () => {
        setErrores(validar({...form, imageURL: "Please enter a valid image URL"}))
    }
