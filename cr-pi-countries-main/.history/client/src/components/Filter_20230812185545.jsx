...
function Filter(props) {
    ...
    const continents = [ "All", "Africa", "North America", "South America", "Antarctica", "Asia", "Europe", "Oceania"]
    ...
    return (
        <section className='filters__container purple white-text'>
            <div className="filters__group">
                <label htmlFor='orden' className='label'>Order:</label>
            ...
            <div className="filters__group">
                <label htmlFor='filterActivity' className='label'>Filter:</label>
                <select onChange={handleFilterActivities} name='filterActivity'>
                    <option defaultValue={true} value= "ignore">Activity:</option>
