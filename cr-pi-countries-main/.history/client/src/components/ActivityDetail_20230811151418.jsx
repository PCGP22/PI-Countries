...
import { activityCreate, idActivitySearch, removeActivity} from '../redux/actions';
...
function ActivityDetail(props) {
    ...
    const initialState = {
        ...
        imageURL: props.currentActivity.imageURL,
        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <br/>
                    <select onChange={handleChange} name="season" defaultValue={initialState.season}>
...
const mapDispatchToProps = (dispatch) => {
    return{
        ...
        idActivitySearch: () => {dispatch(idActivitySearch())},
