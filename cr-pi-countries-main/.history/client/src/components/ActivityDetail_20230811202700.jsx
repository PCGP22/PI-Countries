...
function ActivityDetail(props) {
    ...
    const handleReset = () => {
        ...
        setCountryBox([initialState.countryId])
        setRating(initialState.rating)
        setHover(initialState.rating)
        countryList = []
    }
    ...
    useEffect(() => {
        props.idActivitySearch(idActivity)
        setForm(initialState)
        console.log(form)
        parseCountryList()
        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <br/>
                    <select onChange={handleChange} name="season" defaultValue={'Verano'}>
                        <option value="ignore" >Season:</option>
                        <option value="Primavera" defaultValue={form.season === "Primavera" ? true : false}>Spring</option>
                        <option value="Verano" defaultValue={form.season === "Verano"  ? true : false}>Summer</option>
                        <option value="Otoño" defaultValue={form.season === "Otoño" ? true : false}>Fall</option>
                        <option value="Invierno" defaultValue={form.season === "Invierno" ? true : false}>Winter</option>
                    </select>
                ...
                {activities && activities.map(a=>{
                    ...
                    return(
                        <div className='activityBox' key={a.id}>
                            <button type='button' onClick={handleDeleteActivity} value={a.id}>X</button>
