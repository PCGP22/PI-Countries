...
const validar = (inputs) =>{
    ...
    // optional =>
    if((inputs.imageURL && !regexImg.test(inputs.imageURL)) || (inputs.imageURL && !inputs.imageURL.slice(0,10) === "data:image")){
        console.log(inputs.imageURL && !regexImg.test(inputs.imageURL))
        console.log(inputs.imageURL && !inputs.imageURL.slice(0,10) === "data:image")
        errores.imageURL = "Must be a valid image URL"
    } else if(!inputs.imageURL || regexImg.test(inputs.imageURL) || inputs.imageURL.slice(0,10) === "data:image"){ delete errores.imageURL}
        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'>
                    ...
                    <br/>
                    {form.imageURL? <><img src={`${form.imageURL}`} width={200}/> <br/> </>: ""}
                    {form.imageFile?  <img src={`${form.imageFile}`}  width={200}/> : ""}
                    <p>Or</p>
