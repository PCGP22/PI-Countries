...
const validar = (inputs) =>{
    ...
    if(inputs.imageFile && (inputs.imageFile.size > 15360 || !imageTypes.includes(inputs.imageFile.type))){
        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'>
                    ...
                    <p>Or</p>
                    <input type="file" name='imageFile' onChange={handleChange} >Upload File</input>
