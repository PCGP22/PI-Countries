...
function HomePage(props) {
  ...
  let currentPages = slicePage(pages,currentPage,6)
      ...
      <main className='homePage__container'>
        <section className='homePage__board'>
          ...
          <div className='homePage__navButtons no-space'>
            ...
            <button onClick={handlePrevious} className='pagButton'><FiChevronLeft className="symbolSearch"/></button>
            ...
            <button onClick={handleNext} className='pagButton'><FiChevronRight className="symbolSearch"/></button>
          </div>
        </section>
      </main>
    </>
