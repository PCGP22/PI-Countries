...
const slicePage = (data,currentPage,maxPages) => {
  if(currentPage = 2){
    return data.slice(currentPage-1,currentPage+maxPages)
  }
  if(currentPage>3){
    return data.slice(currentPage-3,currentPage+(maxPages-2))
  }
...
function HomePage(props) {
  ...
  pages = slicePage(pages,currentPage,8)
  ...
  return (
    <>
        ...
        <main>
            ...
            {pages.filter(p=>p>0 && p<pages.length).map(p=>{
              return(
