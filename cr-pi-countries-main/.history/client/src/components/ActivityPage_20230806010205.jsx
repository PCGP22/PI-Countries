...
const validar = (inputs) =>{
    ...
    } else if(!regexNombre.text(inputs.name)){delete errores.name}
    if(inputs.difficulty === 0){ errores.name = "Debes elegir una dificultad"}
    else if(inputs.difficulty !== 0){delete errores.name}
