...
function ActivityPage(props) {
    ...
    const handleClose = (e) => {
        ...
        countryList = countryList.filter(c=> c!== e.target.value)
    }
        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <br/>
                    <input type='number' onChange={handleChange} name="duration" placeholder='1' className='activityPage__numInput' min="1" max="10" step="1"/>
                    <span>Hours</span>
