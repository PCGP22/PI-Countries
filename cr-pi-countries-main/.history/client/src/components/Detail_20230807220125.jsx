          ...
          <section className='detail__info'>
            {props.currentCountry &&
              <>
                ...
                <h3>{name? name: "N/A"}</h3>
                <p><strong>Nombre Oficial:</strong> {offName? offName: "N/A"}</p>
                <p><strong>Capital:</strong> {capitalCity? capitalCity: "N/A"}</p>
                <p><strong>Continente:</strong> {continent? continent: "N/A"}</p>
                <p><strong>Subregión:</strong> {subregion? subregion: "N/A"}</p>
              </>
            }
          </section>
        </main>
        <aside className='detail__aside'>
          <h2>Actividades relacionadas al País</h2>
