            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <select onChange={handleChange} name="season">
                        ...
                        <option value="Primavera" defaultValue={form.season === "Primavera" && true}>Spring</option>
                        <option value="Verano" defaultValue={form.season === "Verano"  && true}>Summer</option>
                        <option value="Otoño" defaultValue={form.season === "Otoño" && true}>Fall</option>
                        <option value="Invierno" defaultValue={form.season === "Invierno" && true}>Winter</option>
                    </select>
