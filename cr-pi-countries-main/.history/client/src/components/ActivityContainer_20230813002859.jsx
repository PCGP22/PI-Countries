        ...
        Activities.map((a) => {
          ...
          return (
            <div className="activityBox" key={a.id}>
              {(pathname.toString() === "/countries/activities/" || pathname.startsWith("/countries/countries/"))  && (
                <>
                  <Link
              ...
              {(pathname.toString() === `/countries/activities/${a.id}` &&
              ...
              <p>Description: {a.description ? a.description.charAt(0).toUpperCase() + a.description.slice(1) : "N/A"}</p>
