            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <select onChange={handleChange} name="season">
                        ...
                        <option value="Primavera" defaultValue={form.season === value && true}>Spring</option>
                        <option value="Verano" defaultValue={form.season === value && true}>Summer</option>
                        <option value="Otoño" defaultValue={form.season === value && true}>Fall</option>
                        <option value="Invierno" defaultValue={form.season === value && true}>Winter</option>
                    </select>
