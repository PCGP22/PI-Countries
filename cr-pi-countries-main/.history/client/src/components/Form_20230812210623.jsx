...
function Form(props) {
  ...
  return (
    <form onSubmit={(e,errores)=>props.handleSubmit} className='activityPage__form'>
        ...
        <div className='activityPage__formButtons'>
            <button onClick={props.handleReset} type="reset" className='activityPage__button'>Clear form</button>
