...
function ActivityDetail(props) {
    ...
    const parseCountryList = () => {
        ...
        console.log(initialState.countryId)
        initialState.countryId.map(async(c)=> {
            let key = c
    ...
    const handleReset = () => {
        ...
        countryList = initialState.countryId
        parseCountryList()
    }
    ...
    return (
        <div className='activityPage__container'>
            <aside className='activityPage__aside'>
                <h1>Edit activity</h1>
                <form onSubmit={handleSubmit} className='activityPage__form' onMouseEnter={()=>setAux(!aux)}>
                    ...
                    <div className='activityPage__formButtons'>
                        <button onClick={handleReset} type="reset" className='activityPage__button'>Load data</button>
                        ...
                        <div className='activityBox' key={a.id}>
                            {props.currentActivity.id === a.id ? "": 
                                <>
                                    ...
                                    <button type='button' onClick={handleDeleteActivity} onMouseLeave={()=>setAux(!aux)} className='activityBox__closeButton' value={a.id}>X</button>
                                </>
                            }
