...
const validar = (inputs) =>{
    ...
    // optional =>
    if(inputs.imageURL && (!regexImg.test(inputs.imageURL) || !inputs.imageURL.slice(0,10).toString() === "data:image")){
        console.log(inputs.imageURL.slice(0,10))
        errores.imageURL = "Must be a valid image URL"
    } else if(!inputs.imageURL || regexImg.test(inputs.imageURL) || inputs.imageURL.slice(0,10).toString() === "data:image"){ delete errores.imageURL}
