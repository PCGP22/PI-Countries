        ...
        <aside className='activityPage__aside'>
            ...
            <form onSubmit={handleSubmit} className='activityPage__form'>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <br/>
                    <input type='number' onChange={handleChange} name="duration" placeholder='2.5 = 2 horas y media' min="0.5" max="10" step="0.5"/>
                    <span>Horas</span>
                ...
                <fieldset className='activityPage__formSection'> 
                    ...
                    <div className='activityPage__countryBox'>
                        {countryBox.length>0 ? countryBox.map(c=>
                            ...
                            <div className='activityPage__countryList'> Añade mínimo un País</div>
                        }
                    </div>
                </fieldset>
                <div className='activityPage__formButtons'>
                    <button onClick={handleReset} type="reset">Clear form</button>
                    <button type='submit' className='submitButton button'>Create</button>
                </div>
            </form>
        </aside>
