        ...
        <main className='activityPage__main'>
            ...
            <section className='activityContainer'>
                {activities.length > 0 && activities.map(a=>{
                    ...
                    const base64String = btoa(String.fromCharCode(...new Uint8Array(a.imageFile.data)));
                    console.log(a.imageFile.data)
                    return(
                        <div className='activityBox' key={a.id}>
                            <h3>Name: {a.name? a.name: "N/A"}</h3>
                            {a.imageURL && <img src={a.imageURL} width={150}/>}    
                            {a.imageFile && <img src={`data:image/png;base64,${base64String}`} width={150}/>} 
                            <p> Difficulty: 
