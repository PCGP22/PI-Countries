...
describe("Testing de searchResults",()=>{
    ...
    test("Cambia la información dependiendo ",async()=>{
        ...
        const routes = [
            {
              path: "/countries/countries/search",
              element: <SearchResults />,
            },
          ];

        const router = createMemoryRouter(routes, {
            initialEntries: ["/countries/countries/search",'/countries/countries/search?name=ken'],
          });
        ...
        // history.push('/countries/countries/search?name=ken');
